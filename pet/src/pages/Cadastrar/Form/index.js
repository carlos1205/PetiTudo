...
class FormCadastro extends Component {
    ...
    async cadastrar(){
        const data = {
            ...
            termoIsSelected: this.state.termoIsSelected,
            receberIsSelected: this.state.receberIsSelected
        };
        const res = await this.props.onPress(data);
        if(res === true){
            this.setState({
                name: "",
                email: "",
